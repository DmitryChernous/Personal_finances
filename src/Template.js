...
// Demo data functions moved to DemoData.js
// pfResetDemoAccounts_, pfCreateDemoAccounts_, pfResetDemoCategories_, pfCreateDemoCategories_
// are now defined in DemoData.js to avoid duplication

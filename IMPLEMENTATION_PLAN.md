...
- [x] Графики: расходы по категориям (pie chart) — реализовано через Charts API
  - **Примечание**: Данные для графика генерируются скриптом (не QUERY формула) для избежания бага #N/A
...
- [x] Пункт меню "Обновить дашборд" для пересчета скриптовых данных
...
- функция очищает все данные, сохраняя структуру и настройки ✅
- опция оставить демо-данные для понимания структуры ✅
...
- инструкция содержит все необходимые разделы: быстрый старт, правила, FAQ, troubleshooting ✅

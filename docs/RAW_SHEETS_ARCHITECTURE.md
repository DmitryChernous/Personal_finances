...
### 3.3. Вариант с другим форматом raw (маппинг)

Если появятся листы с иными заголовками/порядком колонок — можно ввести лист **«Raw_Config»** с маппингом (имя листа → соответствие колонок полям схемы). Текущая реализация рассчитана на формат из п. 3.2.

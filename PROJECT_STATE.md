...
- **Этап 3 (базовая аналитика) завершён**: лист Reports с формулами для доходов/расходов, топ категорий, остатков по счетам. ✅
  - **Важно**: Топ категорий реализован через скриптовый расчет (не QUERY формула) из-за бага Google Sheets с #N/A при программной установке QUERY.
...
- Следующий шаг разработки: **Этап 5** — Подготовка архитектуры импорта или дальнейшее тестирование/доработка Этапов 3-4.
